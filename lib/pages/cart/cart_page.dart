...
class CartPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          Positioned(top: Dimensions.height20 * 3, left: Dimensions.width20,
          ...
          GetBuilder<CartController>(builder: (_cartController){
            return _cartController.getItems.length > 0
                ? Positioned(top: Dimensions.height20 * 5,bottom: 0,
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      ...
                                      if(recommendedIndex >=  0) {
                                        Get.toNamed(RouteHelper.getRecommendFood(recommendedIndex, "cart-page"));
                                      }else {
                                        ...
                                        if (popularIndex < 0) {
                                          Get.snackbar("History product", "Product review is not available for this product",
                                              backgroundColor: AppColors.mainColor,
